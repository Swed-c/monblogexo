...
if (isset($_POST['password'])) {
    ...
    $cryptedPassword = password_hash($password, PASSWORD_BCRYPT, ['salt' => $salt]);
    // GÉNÉRER UN MESSAGE ($message) POUR AFFICHER LE MOT DE PASSE EN VERSION CRYPTÉE
    $message = "Votre mot de passe a été crypté en $cryptedPassword Vous pouvez le copier dans votre base de donnée";
    // FIN SI
}
?>
<!DOCTYPE html>
